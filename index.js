...
// I'm missing the obvious point of how the get this function to have five separate returns
// ie five separate calls
...
// This one sort of makes sense, still a little fuzzy on details.
/*
function makeEchoes(echo, times) {
    let repeatedEcho = "";
    while (times > 0) {
        repeatedEcho = echo + repeatedEcho;
        times--;
    }
    return repeatedEcho;
}
console.log(makeEchoes("Echo!", 5))
*/
...
// Not able to figure out how to make it ONLY show numbers from 191-200
// it is instead printing 200 copies of the parameter entered in the 
// function call
/*
function showMeTheMoney(number) {
    for (i = 0; i < 201; i++) {

        if (number > 190 && number < 201) {
            console.log(number)
        };
    };
}
